...
const movie_routes_1 = require("./controller/movie.routes");
const timeslot_routes_1 = require("./controller/timeslot.routes");
...
(0, database_1.connectToDatabase)(ATLAS_URI)
    ...
    app.use("/movies", movie_routes_1.movieRouter);
    app.use("/timeslot", timeslot_routes_1.timeslotRouter);
